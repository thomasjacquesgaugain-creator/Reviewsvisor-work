            ...
            <div className="bg-card border border-border/60 rounded-2xl p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-prose">
                    <span style={{color:"#2C7BE5"}}>Reviewsvisor</span> {t("features.clearActionDesc1")} <span style={{color:"#3FB27F"}}>{t("features.clearActionDesc2")}</span>.
                  </p>
                </div>
              </div>
            </div>
              ...
              <Accordion type="single" collapsible className="w-full space-y-3">
                <AccordionItem value="item-1" className="border border-border/60 rounded-xl px-4 md:px-6 bg-secondary/30 hover:bg-secondary/50 transition-colors duration-200 data-[state=open]:bg-secondary/50">
                  ...
                  <AccordionContent className="pb-5 pl-8 text-muted-foreground leading-relaxed">
                    Reviewsvisor utilise une intelligence artificielle avancée pour analyser vos avis clients. L'outil lit chaque commentaire, identifie le ton et l'émotion, <span className="text-green-500 font-medium">extrait les mots-clés importants</span> et détecte automatiquement les points forts et les points faibles. Vous obtenez ensuite <span className="text-green-500 font-medium">une synthèse claire avec des axes d'amélioration prioritaires</span>.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-3" className="border border-border/60 rounded-xl px-4 md:px-6 bg-secondary/30 hover:bg-secondary/50 transition-colors duration-200 data-[state=open]:bg-secondary/50">
                  ...
                  <AccordionContent className="pb-5 pl-8 text-muted-foreground leading-relaxed">
                    L'IA regroupe les retours clients par thématiques récurrentes (accueil, qualité, prix, service, ambiance, etc.). Elle mesure la fréquence et la tonalité de chaque sujet pour établir <span className="text-green-500 font-medium">une liste claire des priorités d'amélioration à fort impact</span>.
                  </AccordionContent>
                </AccordionItem>
