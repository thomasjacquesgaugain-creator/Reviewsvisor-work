...
export function BillingReports() {
  ...
  return (
    <div className="p-8">
      ...
      {loading ? (
        <div className="flex items-center gap-3 rounded-lg border border-gray-200 bg-white p-6 text-sm text-muted-foreground">
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3">
                            <div className="text-right">
                              ...
                              <p className="text-xs text-gray-500"> {t("settings.myMonthlyReports.stripeInvoice")}</p>
                            </div>
      ...
      {!loading && invoices.length === 0 && !error && (
        <div className="mt-8 text-center py-12">
          ...
          <p className="text-gray-500"> {t("settings.myMonthlyReports.noInvoiceAvailable")}</p>
        </div>
      )}
    </div>
  );
