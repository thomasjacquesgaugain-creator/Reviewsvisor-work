      ...
      <section className="pt-10 pb-4 md:pt-14 md:pb-6">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            {/* Icon */}
            <div className="mb-5 inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary/10 border border-primary/20">
          ...
          <div className="max-w-xl mx-auto">
            <Card className="border border-border/50 shadow-md hover:shadow-lg transition-shadow duration-300 bg-card">
              <CardContent className="p-6 md:p-8 text-center">
                <div className="mb-4 inline-flex items-center justify-center w-20 h-16 rounded-full bg-primary/10">
                  <Mail className="w-10 h-8 text-primary" />
                </div>
