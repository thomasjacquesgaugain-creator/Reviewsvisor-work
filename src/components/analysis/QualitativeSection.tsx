          ...
          <div>
            ...
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 md:p-6 dark:border-slate-700 dark:bg-slate-800/40">
                ...
                <div className="transition-opacity duration-200">
                  {wordsByFrequency.length === 0 ? (
                    <div className="text-center py-8">
                      <p className="text-sm text-slate-500 dark:text-slate-4000">{t("analysis.qualitative.noDataForMode")}</p>
                    </div>
                  ) : (
              ...
              {sortMode === 'frequency' && wordsByFrequency.length === 0 && (
                <div className="text-center py-8">
                  <p className="text-sm text-gray-500 dark:text-slate-400">{t("analysis.qualitative.noDataForMode")}</p>
                </div>
              )}
