      ...
      <CardContent className="p-0">
        ...
        <div className="flex items-start gap-3 px-6 pt-5 pb-4 border-b border-gray-100">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm italic text-slate-400">(PDCA)</span>
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button type="button" className="text-violet-400 hover:text-violet-600 transition-colors">
                      <Info className="h-4 w-4" />
                    </button>
                  </TooltipTrigger>
                  <TooltipContent side="top" className="max-w-xs rounded-xl border bg-white p-4 text-sm leading-6 text-slate-700 shadow-xl">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div style={{ borderLeftColor: "#8B5CF6" }}
            className="rounded-2xl border border-violet-200 bg-violet-50 border-l-4 overflow-hidden">
          ...
          <div style={{ borderLeftColor: "#F97316" }} className="rounded-2xl border border-orange-200 bg-orange-50 border-l-4 overflow-hidden">
            <div className="flex items-start justify-between px-5 py-4">
          ...
          <div style={{ borderLeftColor: "#EAB308" }} className="rounded-2xl border border-yellow-300 bg-yellow-50 border-l-4 overflow-hidden">
            <div className="flex items-start justify-between px-5 py-4">
              <div className="flex items-start gap-3 flex-1 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    <span className="inline-flex items-center rounded-full bg-white border border-gray-200 px-3 py-1 text-xs text-gray-700">
              ...
              <div className="ml-4 mt-0.5 inline-flex items-center gap-1.5 rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-600 shrink-0">
          ...
          <div style={{ borderLeftColor: "#22C55E" }} className="rounded-2xl border border-green-200 bg-green-50 border-l-4 overflow-hidden">
            <div className="flex items-start justify-between px-5 py-4">
              <div className="flex items-start gap-3 flex-1 min-w-0">
              ...
              <div className="flex items-center gap-1.5 rounded-full bg-white border border-gray-200 px-3 py-1.5 text-xs font-semibold text-blue-600 shrink-0 ml-4 mt-0.5">
