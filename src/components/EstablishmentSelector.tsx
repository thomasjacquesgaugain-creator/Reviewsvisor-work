  ...
  if (establishments.length === 0) {
    return (
      ...
      >
        ...
        {t("establishment.selector.create")}
      </Button>
    );
  }
    ...
    <div className="relative">
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            className="flex items-center gap-3 h-auto py-2 px-3 min-w-[200px] max-w-[280px] justify-between bg-primary-foreground hover:bg-primary-foreground hover:text-foreground hover:border-border"
          >
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="text-left min-w-0">
                <div className="font-medium text-foreground truncate max-w-[140px]">
                  {selectedEstablishment?.name || t("establishment.selector.placeholder")}
                </div>
        ...
        >
          <div className="space-y-1">
            <div className="text-sm font-medium text-muted-foreground px-3 py-2">
              {t("establishment.selector.title")}
            </div>
