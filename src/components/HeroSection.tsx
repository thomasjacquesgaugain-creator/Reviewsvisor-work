          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto">
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg rounded-2xl p-6">
              <CardContent className="p-0 space-y-4">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">{t("hero.card1Desc")}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg rounded-2xl p-6">
              <CardContent className="p-0 space-y-4">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">{t("hero.card3Desc")}</p>
              </CardContent>
            </Card>
          </div>
