...
-- First, update any NULL user_id records in review_insights
-- We'll need to assign them to existing users or delete them
-- Since these are analytics, we'll delete orphaned records
...
-- "insights:own", "ri_select_self", "Users can view insights for their establishments"
