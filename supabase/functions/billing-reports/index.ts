...
const INVOICE_PDF_COPY: Record<InvoiceLanguage, InvoicePdfCopy> = {
  ...
  es: {
    ...
    quantity: "CANT.",
    unitExclTax: "P.U. SIN IVA",
    tax: "IVA",
    amountExclTax: "IMPORTE SIN IVA",
    period: (start, end) => `Periodo del ${start} al ${end}`,
    totalExclTax: "Total sin IVA",
    taxLine: (country, percentage, taxableAmount) =>
      `IVA - ${country} (${percentage} % sobre ${taxableAmount})`,
    totalInclTax: "TOTAL CON IVA",
    defaultEstablishment: "Establecimiento",
    defaultDescription: "Suscripción Reviewsvisor",
  },
  it: {
    locale: "it-IT",
    ...
    quantity: "QTÀ",
    unitExclTax: "P.U. IVA ESC.",
    tax: "IVA",
    amountExclTax: "IMPORTO IVA ESC.",
    period: (start, end) => `Periodo dal ${start} al ${end}`,
    totalExclTax: "Totale IVA escl.",
    taxLine: (country, percentage, taxableAmount) =>
      `IVA - ${country} (${percentage} % su ${taxableAmount})`,
    totalInclTax: "TOTALE IVA INCL.",
    defaultEstablishment: "Struttura",
    defaultDescription: "Abbonamento Reviewsvisor",
  },
  pt: {
    locale: "pt-PT",
    invoiceTitle: "FATURA",
    ...
    quantity: "QTD.",
    unitExclTax: "P.U. S/ IVA",
    tax: "IVA",
    amountExclTax: "VALOR S/ IVA",
    period: (start, end) => `Período de ${start} a ${end}`,
    totalExclTax: "Total s/ IVA",
    taxLine: (country, percentage, taxableAmount) =>
      `IVA - ${country} (${percentage} % sobre ${taxableAmount})`,
    totalInclTax: "TOTAL C/ IVA",
    defaultEstablishment: "Estabelecimento",
    defaultDescription: "Subscrição Reviewsvisor",
  },
};
